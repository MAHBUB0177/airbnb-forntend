...
let homeimage = [
  { image: home3, title: "Park 12 Apartments", desc: "San Diego, California" },
  {
    image: home2,
      ...
      <div className="px-2 md:px-[200px] ">
        <div className="mt-10 mb-10">
          ...
          <div className="mt-5 px-[50px]">
            <p className=" text-md md:text-xl  flex justify-center item-center">
              We’ve partnered with apartment buildings across the US that let
              you rent a place to live and Airbnb it part-time. Explore
