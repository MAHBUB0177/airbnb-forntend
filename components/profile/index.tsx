            ...
            <div className="md:flex no-wrap">
                ...
                <div className="w-full md:w-3/12 m-2 shadow-2xl">
                    <div className="bg-white p-3 border-t-4 border-primary">
                        ...
                        <img className="h-32 w-32 rounded-full border-4 border-white mx-auto my-4" src={ authData?.image} alt="" />
                        </div>
                        <div className="py-2">
                                    <h3 className="font-bold text-2xl mb-1">{ `${authData?.firstName} ${authData?.lastName}`}</h3>
