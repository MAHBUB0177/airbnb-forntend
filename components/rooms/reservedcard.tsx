...
const ReservedCard = () => {
  return (
    <div className="pt-8 flex justify-between pb-20 w-full gap-10">
      <div className="w-2/3">
        ...
        <p className="text-textprimary pt-3">
          ...
          heart of the Galilee nature. Unique Extended and relaxing unit Located
          on the 2nd floor with two balconies overlooking a fascinating view
